...
const DataProtectionPolicy = () => {
  return (
    <Box component="section">
      ...
      <Typography variant="body1">
        許可番号：23-ユ-303247<br/>事業所の名称及び所在地：株式会社レクト
          ...
          <Table aria-label="fee table">
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  成功報酬（期間の定めのない雇用契約の紹介の場合）当該求職者の就職後１年間に支払われる賃金（内定書や労働条件通知書等に記載されている額）の100％（期間の定めのある雇用契約の紹介の場合）当該求職者の就職後、雇用契約期間中（雇用期間が１年を超える場合は最大１年間分）に支払われる賃金（内定書や労働条件通知書等に記載されている額）の50％手数料負担者は求人者とします。
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                ...
                <TableCell>
                  成功報酬当該求職者の就職後１年間に支払われる賃金（内定書や労働条件通知書等に記載されている額）の30％手数料負担者は求人者とします。
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
          ...
          <Table aria-label="fee table">
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  着手金100,000円活動1日あたり<br/>
                  30,000円(または活動1時間あたり5,000円)成功報酬(期間の定めのない雇用契約の紹介の場合)当該求職者の就職後１年間に支払われる賃金（内定書や労働条件通知書等に記載されている額）の35％
          ...
          <Table aria-label="fee table">
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  着手金30,000円相談・助言終了時30,000円成功報酬40,000円手数料負担者は関係雇用主とします。
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
