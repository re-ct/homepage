...
const accordionData = [
  ...
  },
  {
    ...
    answer:
      <>必要ありません。 Re:ProSは、論理的思考力の習得に最適なScratchに特化しており、教材も全てScratchベースでご提供します。<br />将来的にさらに高度な言語を希望される生徒様には、本部から適切な学習方法をご案内いたします。</>,
  },
  {
    id: 'panel3',
    question: '講師として指導するにあたり、教員免許や特別な資格は必要ですか？',
    answer: 
      <>特別な免許や資格は一切必要ありません。<br />教育業界未経験の方でも安心してスタートできるよう、指導マニュアルとサポート体制を整えています。</>,
  },
  {
    id: 'panel4',
    question: '教室運営中、技術的なトラブルが発生した場合、本部に相談できますか？',
    answer:
  ...
  },
  {
    ...
    answer:
      <>週末の数時間（例えば土曜の午後のみなど）から開講が可能です。<br />開講前のみ、教材・指導マニュアルを確認する時間が必要となります。</>,
  },
  {
    id: 'panel6',
  ...
  },
  {
    ...
    answer:
      <>はい、開校場所（自宅やレンタルスペースなど）と、生徒の人数に応じた PCやタブレット、インターネット環境をご用意いただきます。</>,
  },
  {
    id: 'panel8',
          ...
          <Box sx={sxStyles.wrap}>
            {accordionData.map((item) => (
              <Accordion key={item.id} sx={sxStyles.accordion}>
                ...
                >
                  <Typography sx={sxStyles.accordionSummaryText} component="span">Q</Typography>
                    {item.question}
                </AccordionSummary>
